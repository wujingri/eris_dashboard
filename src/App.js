...
import WbnbToBusdAbi from './artifacts/BUSD_WBNB_PAIR.json';
...
const ERIS_TOKEN_ADDRESS  = "0xba96731324de188ebc1ed87ca74544ddebc07d7f";
...
function App() {
  ...
  async function refreshPage() {
    try {
      ...
      const marketCap = await erisTokenContract.totalSupply();
      setMarketVal((ethers.utils.formatEther(marketCap) * tokenPrice * 0.1047).toFixed(2));
      ...
      log("[ERIS] Refresh page. Fetching contracts error! (%s)", err.message);
    }
  }
